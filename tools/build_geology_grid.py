# -*- coding: utf-8 -*-
"""USGS 統合地質図（ポリゴン）を1度グリッド 64,800 点に空間結合し、
data/moon_geology_grid.csv を作る。
...
元データ（パブリックドメイン, USGS 刊行物）:
  ...
  ダウンロード先の例: https://pubs.usgs.gov/sim/3316/  → "Download the GIS data"

処理:
  1. 1度グリッド（180×360）の各セル中心 (lat+0.5, lon-179.5 …) を作る
...
OUT = ROOT / "data" / "moon_geology_grid.csv"
